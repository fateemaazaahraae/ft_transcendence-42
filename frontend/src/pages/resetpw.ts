...
export default function ResetPw() {
  return `<div class="min-h-screen w-full flex items-center justify-center gap-[8px] relative pt-[3%]">
    ...
    <div class="relative inset-0 items-center h-[500px] md:h-[700px] w-full md:w-[820px] pt-[110px] md:pt-[130px] rounded-[50px] overflow-hidden mr-[3%] ">
        ...
        <div class="relative inset-0 m-auto w-[320px] md:w-[480px] lg:w-[480px] h-[250px] md:h-[300px] px-2 sm:px-6 py-6 sm:py-10 pt-[40px] pb-[60px] items-center bg-black rounded-[40px] md:rounded-[50px] backdrop-blur-[10px] mt-[50px]">
