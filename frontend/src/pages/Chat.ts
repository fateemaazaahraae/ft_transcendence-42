...
export default async function Chat() {
    ...
    <div class="absolute top-10 right-[5%] flex items-center gap-4">
      ...
      <div id="chat_panels_wrapper" 
        ...
        <div class="w-full bg-primary/60 rounded-xl  p-4 flex flex-col h-full overflow-hidden">
           <div class="relative ">
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              ...
              <input
                type="search"
                id="default-search"
                class="block bg-primary/80 w-full h-[35px] px-4 pl-9 text-sm text-white rounded-2xl border-none focus:outline-none placeholder-white"
                placeholder="Search ..." 
                required
              />
        ...
        <div id="main_chat" 
         class="w-full  
                ...
                md:relative md:flex lg:w-[90%] md:w-[90%] h-[700px] md:h-[700px]">
              <div id="chatContainer" class="w-full h-full flex flex-col">
                <div id="chatHeader" class=" relative md:h-16 flex items-center justify-between md:pl-8 p-3 rounded-t-xl bg-primary/80"> <div class="flex items-center gap-3">
                <i id="backToContacts"
    ...
    <img id="chatContactAvatar" src="/green-girl.svg" class="w-12 h-12 object-cover border border-primary rounded-full">
          ...
          <div id="dropdownMenu" class="hidden absolute right-3 top-12 bg-[#35C6DD] backdrop-blur-md rounded-lg shadow-lg py-2 w-40 z-50">
            ...
            <div id="blockConfirmation" class="hidden absolute inset-0 items-center justify-center">
                <div class="confirm bg-primary/65 p-8 rounded-xl shadow-md text-center max-w-xs w-full mx-2 min-h-[160px] flex flex-col justify-between">
                  <p class=" text-white text-lg">Block ?</p>
                  <div class="flex items-center justify-center gap-10 ">
                    <button id="confirmBlockBtn" class="bg-red-500 hover:bg-red-700 text-white rounded-2xl font-bold py-2  w-[100px]">Block</button>
                    <button id="cancelBlockBtn" class="bg-green-400 hover:bg-green-700 text-white rounded-2xl font-bold py-2 w-[100px]">Cancel</button>
                 </div>
