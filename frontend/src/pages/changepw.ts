...
export default function ChangePw() {
  return `
    ...
    <div class="relative h-[420px] w-[480px] pt-[40px] pb-[60px] items-center px-[50px] bg-black rounded-[50px] backdrop-blur-[10px] ml-[1580px] ">
      <form action="">
        <h2
        ...
        <div class="input-box mt-5 mb-10">
          <input 
            type="password" 
            required 
...
>>>>>>> b0a02b0fc80573ebe4589c8905a7432f26ebe29d:frontend/src/pages/changepw.ts
  </div>
  `;
}
