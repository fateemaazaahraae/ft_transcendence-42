...
export default function Landing() {
  return `
    <div class="w-full h-full flex flex-col items-center pt-40 overflow-x-hidden">
    <div class="relative text-center">
      ...
      <img src="/images/dark-girl.svg" class="drop-shadow-blue opacity-0 md:opacity-100 md:w-auto md:max-w-[170px] lg:max-w-[220px] xl:max-w-[400px] ">
      <img src="/images/table1.png" class="mt-20 w-auto max-w-[320px] lg:max-w-[500px] xl:max-w-[600px] ">
      ...
      <img src="/images/purple-girl.svg" class="drop-shadow-purple w-auto max-w-[150px] md:max-w-[280px] lg:max-w-[350px] xl:max-w-[400px] -translate-y-[80px] lg:-translate-y-[120px] xl:-translate-y-[150px]">
      <img src="/images/red-boy.svg" class=" drop-shadow-red w-auto max-w-[180px] md:max-w-[280px] lg:max-w-[350px] xl:max-w-[450px]">
      <img src="/images/green-girl.svg" class="drop-shadow-green w-auto max-w-[160px] md:max-w-[280px] lg:max-w-[350px] xl:max-w-[400px] -translate-y-[80px] lg:-translate-y-[120px] xl:-translate-y-[150px]">
      </div>
