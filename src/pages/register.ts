...
export default function Register() {
  return `<div class="min-h-screen w-full flex items-center justify-center gap-[170px] relative pt-[7%] md:pt-[3%]">
        <img src="/images/blue-boy33.svg" alt="Blue Boy" class="hidden lg:flex md:items-center md:justify-center w-[500px] h-auto mt-[7%] ml-[300px] drop-shadow-[0_0_17px_rgba(0,160,255,255.7)]">
    ...
    <form action="">
        ...
        <div class="flex items-center justify-between gap-[10px] pb-0 md:pb-[3px] pr-[5px] pl-0 w-[290px] md:w-[430px] my-[17px] md:my-[30px] mx-auto bg-none rounded-[20px] ">
            ...
            <input type="text" required placeholder="First name" class="w-full h-[45px] md:h-[52px] px-[20px] py-[15px] bg-black font-roboto text-white border-none shadow-[0_0_10px_rgba(53,198,221,0.9)] focus:shadow-[0_0_10px_rgba(255,255,255,0.9)] text-[0.9em] font-medium outline-none placeholder:text-gray-400 transition-shadow duration-400 ease-in-out rounded-[20px] placeholder:text-[0.9em] ">
            <span class="icon"></span>
            <input type="text" required placeholder="Last name" class="w-full h-[45px] md:h-[52px] px-[20px] py-[15px] bg-black font-roboto text-white border-none shadow-[0_0_10px_rgba(53,198,221,0.9)] focus:shadow-[0_0_10px_rgba(255,255,255,0.9)] text-[0.9em] font-medium outline-none placeholder:text-gray-400 transition-shadow duration-400 ease-in-out rounded-[20px] placeholder:text-[0.9em] ">
        </div>
        <div class="flex items-center justify-between gap-[10px] pb-0 md:pb-[3px] pr-[5px] pl-0 w-[290px] md:w-[430px] my-[17px] md:my-[30px] mx-auto bg-none rounded-[20px] ">
            <span class="icon"></span>
            <input type="text" required placeholder="User name" class="w-full h-[45px] md:h-[52px] px-[20px] py-[15px] bg-black font-roboto text-white border-none shadow-[0_0_10px_rgba(53,198,221,0.9)] focus:shadow-[0_0_10px_rgba(255,255,255,0.9)] text-[0.9em] font-medium outline-none placeholder:text-gray-400 transition-shadow duration-400 ease-in-out rounded-[20px] placeholder:text-[0.9em] ">
        </div>
        <div class="flex items-center justify-between gap-[10px] pb-0 md:pb-[3px] pr-[5px] pl-0 w-[290px] md:w-[430px] my-[17px] md:my-[30px] mx-auto bg-none rounded-[20px] ">
            <span class="icon"></span>
        ...
        <div class="flex items-center justify-between gap-[10px] pb-0 md:pb-[3px] pr-[5px] pl-0 w-[290px] md:w-[430px] my-[17px] md:my-[30px] mx-auto bg-none rounded-[20px] ">
            <span class="icon"></span>
            <input type="password" required placeholder="Password" class="w-full h-[45px] md:h-[52px] px-[20px] py-[15px] bg-black text font-roboto-white border-none shadow-[0_0_10px_rgba(53,198,221,0.9)] focus:shadow-[0_0_10px_rgba(255,255,255,0.9)] text-[0.9em] font-medium outline-none placeholder:text-gray-400 transition-shadow duration-400 ease-in-out rounded-[20px] placeholder:text-[0.8em] ">
            <span class="icon"></span>
            <input type="password" required placeholder="Confirm Password" class="w-full h-[45px] md:h-[52px] px-[20px] py-[15px] bg-black font-roboto text-white border-none shadow-[0_0_10px_rgba(53,198,221,0.9)] focus:shadow-[0_0_10px_rgba(255,255,255,0.9)] text-[0.9em] font-medium outline-none placeholder:text-gray-400 transition-shadow duration-400 ease-in-out rounded-[20px] placeholder:text-[0.8em] ">
        </div>
