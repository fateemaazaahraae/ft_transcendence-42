...
<!--I removed glow from this part-->
    <div class="relative inset-0 items-center h-[900px] w-[820px] pt-[40px] pb-[60px] px-[20px] rounded-[50px] overflow-hidden ml-[1%] ">

    <div class="absolute rounded-full blur-[55px] opacity-70 w-[250px] h-[350px] bg-[#35C6DDE5] left-[calc(50%-320px)] top-[15%] -rotate-[20deg]"></div>
    <div class="absolute inset-0 rounded-full blur-[55px] opacity-100 w-[300px] h-[500px] bg-[#D02EA48A] left-[calc(50%-8px)] bottom-[60%] top-[33%] -rotate-[35deg]"></div>
    <div class="relative inset-0 m-auto w-[530px] mt-[7%] pt-[2%] pb-[2%] px-[50px] bg-black rounded-[50px] blur-[10]">
    <form action="">
        <h2
