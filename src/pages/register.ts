...
export default function Register() {
  return `<div class="flex items-center inset-0 gap-[170px] relative pt-[3%] overflow-hidden ml-[1%]">
    ...
    <div class="absolute rounded-full blur-[55px] opacity-100 w-[130px] h-[260px] md:w-[300px] md:h-[500px] bg-[#D02EA48A] right-[calc(50%-149px)] md:left-[calc(50%-8px)] md:bottom-[60%] top-[65%] md:top-[33%] -rotate-[35deg]"></div>
    
    <div class="relative inset-0 m-auto h-full md:h-[650px] w-full md:w-[530px] mt-[7%] pt-[2%] pb-[2%] px-[50px] bg-red-500 rounded-[50px] blur-[10]">
    <form action="">
        <h2
        ...
        Register Now !</h2>
        <div class="flex justify-between gap-[10px] pb-0 md:pb-[3px] pr-[5px] pl-0 w-[230px] md:w-[430px] my-[15px] md:my-[30px] bg-none rounded-[20px] ">
