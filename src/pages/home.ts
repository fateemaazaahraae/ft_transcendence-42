export default function Home() {
  ...
  return `
   <div class="relative w-full h-screen">
    ...
    <!-- Sidebar -->
    <div class="fixed bottom-[30%] left-6 flex flex-col items-center gap-10 z-50">
      <div class="flex items-center justify-center w-[40px] h-[40px] bg-primary hover:bg-secondary rounded-full">
        <i class="fa-solid fa-house text-[22px] text-black cursor-pointer"></i>
      </div>
      <i class="fa-solid fa-user text-[22px] text-primary hover:text-secondary cursor-pointer"></i>
      <i class="fa-solid fa-trophy text-[18px] text-primary hover:text-secondary cursor-pointer"></i>
      <i class="fa-solid fa-user-group text-[22px] text-primary hover:text-secondary cursor-pointer"></i>
      <i class="fa-solid fa-comments text-[22px] text-primary hover:text-secondary cursor-pointer"></i>
      <i class="fa-solid fa-gear text-[22px] text-primary hover:text-secondary cursor-pointer"></i>
    </div>
