export default function Game(){
  const game={
    ...
    <div class="absolute flex top-[20%] gap-[10%] left-[43%] -translate-x-1/2 lg:top-[20%] xl:top-[15%]">
        ...
        <div class="flex flex-col items-center gap-3 ">
          <h1 class="font-roboto text-center text-[18px] lg:text-xl xl:text-2xl truncate w-[100px]"> ${game.match[0].player1.name} </h1>
        ...
        <div class="flex flex-col items-center gap-3 lg:ml-[20%] ">
        <h1 class=" font-roboto text-center text-[18px] lg:text-xl xl:text-2xl "> ${game.match[0].player2.name} </h1>
    ...
    <div class="absolute lg:top-[35%] xl:top-[30%] top-[30%] left-[18%] w-[65%] h-[60%] lg:w-[70%] lg:h-[50%] xl:h-[60%] bg-black rounded-3xl drop-shadow-cyan lg:flex flex flex-col justify-between items-center overflow-hidden">
